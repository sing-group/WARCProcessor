...
public class GeneratingCorpusDialog extends CustomJDialog {
	...
	public GeneratingCorpusDialog(WarcGeneratorGUI view,
		...
		lblNewLabel
				.setIcon(new ImageIcon(
						GeneratingCorpusDialog.class
								.getResource("/resources/com/warcgenerator/gui/resources/img/imagen_gif.gif")));
		...
		openOutputFolderCBox = new CustomCheckBox();
		openOutputFolderCBox
				.setName("GeneratingCorpusDialog.openOutputFolderCBox.text");
		view.addLocaleChangeListener(openOutputFolderCBox);
	...
	public void setOpenOutputFolderCBox(CustomCheckBox openOutputFolderCBox) {
